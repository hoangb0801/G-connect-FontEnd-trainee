...
function reder() {
    ...
    sinhVienList.forEach(function (sv) {
        ...
        <td class="txtNgaySinh">${formatDate(sv.ngaySinh)}</td>
        <td class="txtGioiTinh">${sv.gioiTinh}</td>
        <td class="txtKhoa">${sv.maKhoa}</td>
        <td>
            <i onclick="editClick" class="icon-edit fa-solid fa-pen-to-square"></i>
            <i onclick="deleteClick" class="icon-delete fa-solid fa-trash"></i>
        </td>
    </tr>
        `;
    }
